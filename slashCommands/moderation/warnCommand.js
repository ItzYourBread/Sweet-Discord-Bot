...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (target.id === interaction.guild.me.id) return interaction.reply({
        ...
        if (target.roles.highest.position >= interaction.guild.me.roles.highest.position) return interaction.reply({
        ...
        .setDescription(`**${interaction.user.tag}** are you sure you want to warn **${target.user.tag}**?`)
...
.setDescription(`**${interaction.user.tag}** are you sure you want to remove warn from **${user}**?`)
                .setFooter(client.user.tag, client.user.displayAvatarURL())
                .setColor(client.config.embedColor)
                .setTimestamp()
