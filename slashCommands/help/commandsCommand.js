...
module.exports = {
    ...
    run: async (client, interaction, args) => {
        ...
        let dmMessage = new discord.MessageEmbed()
            .setDescription(
                `Thanks for using our discord bot, vote us on [Discord bot list](https://discordbotlist.com/bots/fox/upvote) to support Sweet developers and keep the bot alive.\n\nHave a good day!`
            )
        ...
        let embed = new discord.MessageEmbed()
            ...
            .addFields(
                ...
                {
                    name: '🍬 Currency',
                    value: '`balance`, `beg`, `daily`, `shop` ',
                },
                {
                    name: '🥐 Foods',
                    value: '`bread`, `pizza`, `cake`, `milk` ',
                },
                ...
                {
                    name: '👮‍♀️ Moderation',
                    value: '`ban`, `kick`, `warn add`, `warn remove`, `warn check`, `purge`, `timeout`, `unban`, `channel lock`, `channel unlock`, `slowmode` ',
                },
                { name: '⚙️ Server settings', value: '`settings set-modlogs`' },
                {
                    name: '🔧 Utility',
                    value: '`help`, `ping`, `avatar`, `stats`, `weather`, `userinfo`, `serverinfo`, `vote`, `credits` ',
                }
            )
