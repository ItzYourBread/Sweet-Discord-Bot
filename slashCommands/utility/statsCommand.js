...
module.exports = {
    ...
    .addFields(
				{
					name: 'General',
					value: `** **\ **Name:** ${client.user.tag}\n  **Shard:**  #${interaction.guild.shardId + 1} / ${client.shard.count}\n  **Guilds:** ${client.guilds.cache.size} / ${guildstotal.reduce((acc, guildCount) => acc + guildCount, 0)}\n  **Users:** ${client.users.cache.size} / ${userstotal.reduce((acc, userCount) => acc + userCount, 0)}\n  **Channels:** ${client.channels.cache.size} / ${channelstotal.reduce((acc, channelCount) => acc + channelCount, 0)}\n  **Websocket Status:** ${client.ws.status}\n  **Websocket Ping:** ${client.ws.ping.toLocaleString()}ms\n** **`,
					inline: true,
				},
                {
                    name: `System`,
			...
			.setFooter(`Made by Arif | Cluster: 1 | Shard: ${client.shard.count} | Version: Sweet 1.4.0`)
      .setColor(client.config.embedColor)
            
			interaction.editReply({ content: `\ `, embeds: [embed] }).catch((e) => interaction.followUp(e));
    }
}