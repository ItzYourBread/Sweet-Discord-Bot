...
module.exports = {
    ...
    run: async (client, interaction, args) => {
        if (interaction.options.getSubcommand() === 'start') {
            ...
            let host =
                interaction.options.getUser('host') || `${interaction.member}`;
            ...
            manager
                .start(channel, {
                    ...
                    messages: {
                        giveaway:
                            ' <:SweetTada:981624346672001124>**Giveaway**<:SweetTada:981624346672001124>',
                        giveawayEnded:
                            '<:SweetTada:981624346672001124>**Giveaway Ended**<:SweetTada:981624346672001124>',
                ...
                .then((s) => {
                    interaction.reply(
                        `${client.config.success} Giveaway Started in ${channel}`
                    );
                })
                .catch((e) => {
                    console.log(e);
            ...
            manager
                ...
                .then((s) => {
                    interaction.reply({
                        content: `${client.config.success} Giveaway rerolled!`,
                        ephemeral: true,
                    });
                })
                .catch((e) => {
            ...
            manager
                ...
                .then((s) => {
                    interaction.reply({
                        content: `${client.config.success} Giveaway ended!`,
                        ephemeral: true,
                    });
                })
                .catch((e) => {
