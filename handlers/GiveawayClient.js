...
const GiveawayManagerWithOwnDatabase = class extends GiveawaysManager {
    ...
    generateMainEmbed(giveaway) {
        ...
        let mainEmbed = new MessageEmbed()
            ...
            .setTitle(
                `<:SweetGift:980949624921657424> **${giveaway.prize}** Giveaway`
            )
            .setDescription(
            ...
            .setImage(
                `https://media.discordapp.net/attachments/984777201805299733/985979019466010634/0C618A02-605B-4E40-820A-1B8D81F6151F.png`
            )
    ...
    generateEndEmbed(giveaway, winners) {
        let endEmbed = new MessageEmbed()
            .setColor(client.config.embedColor)
            .setTitle(
                `<:SweetGift:980949624921657424> **${giveaway.prize}** Giveaway Ended`
            )
            .setDescription(
